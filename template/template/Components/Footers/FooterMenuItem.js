...
function FooterMenuItem({ onPress, height,width, title, icon, backColor, frontColor,borderColor, disabled }) {
    ...
    return (
        <TouchableOpacity style={{width:width, height:height, backgroundColor:backColor, alignItems:'center', flexDirection:'row', paddingLeft:10, paddingRight:10, borderColor:borderColor, borderBottomWidth:1}} onPress={disabled ? undefined : onPress}>
